/*
 * ARMCC startup file for PIC32CM5164JH01048
 *
...
// Check if DeviceVectors is defined and create a typedef to VECTOR_TABLE_Type
    ...
    typedef DeviceVectors VECTOR_TABLE_Type; // Defines the toolchain agnostic type of the vector table type defined in the 'pic32cm5164jh01048.h'
